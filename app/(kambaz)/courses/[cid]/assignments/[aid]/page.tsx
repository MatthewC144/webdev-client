            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                id="wd-group" defaultValue="ASSIGNMENTS"
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                id="wd-display-grade-as" defaultValue="Percentage"
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                id="wd-submission-type" defaultValue="Online"
                            >
                            ...
                            <input
                                type="checkbox" id="wd-text-entry" />
